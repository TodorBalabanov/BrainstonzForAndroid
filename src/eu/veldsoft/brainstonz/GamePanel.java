...
public class GamePanel extends JPanel {
	...
	public void paint(Graphics g) {
		int bgW = ImageLoader.background.getWidth(), bgH = ImageLoader.background
				.getHeight(), columns = (int) Math.ceil((double) this
				.getWidth() / (double) bgW), rows = (int) Math
				.ceil((double) this.getHeight() / (double) bgH);
