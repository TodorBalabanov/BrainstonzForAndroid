...
class SidePanel extends JPanel {
	...
	static class PlayerPanel extends JPanel {
		...
		public PlayerPanel(int player) {
			super(new GridBagLayout());
			this.setOpaque(false);
			TitledBorder border = new TitledBorder((player == 1 ? "Black"
					: "White"));
			...
			JLabel easy = new JLabel("Easy"), hard = new JLabel("Hard");
			...
			SwingUtilities.invokeLater(new Runnable() {
				...
				public void run() {
					slider.setEnabled(enable
							&& typeSelect.getSelectedIndex() == 1);
					sliderLabel.setEnabled(enable
							&& typeSelect.getSelectedIndex() == 1);
	...
	private static class OptionsPanel extends JPanel {
		...
		public OptionsPanel() {
			...
			slider.setOpaque(false);
			Hashtable<Integer, JLabel> labelTable = new Hashtable<Integer, JLabel>();
			JLabel fast = new JLabel("Fast"), slow = new JLabel("Slow");
